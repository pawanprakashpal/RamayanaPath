    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="text-center mb-12">
        <div className="flex justify-center mb-4">
          <div className="w-24 h-24 rounded-full bg-[#f97316] dark:bg-[#f97316] p-4 flex items-center justify-center animate-hero-icon">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/ram-icon.png" alt="Shree Ram with bow and arrow" width="64" height="64" className="w-16 h-16" />
          </div>
        </div>
        <p className="font-devanagari text-lg text-[var(--accent)] mb-2 animate-hero-title">
          ॥ श्रीरामचरितमानस ॥
        </p>
